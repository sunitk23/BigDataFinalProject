...
# Fetching data from the requests.py file
...
# Scheduking the tasks to the workers based on the scheduling algorithm
...
def workerUpdataData():
    ...
    while True:
        connection, _ = TCPsocket.accept()
        taskUpdateData = connection.recv(1024)
        ...
        if taskUpdateData:
            ...
            if jobRequestID in listOfKeys:
                ...
                if nMapTasksPerJob[jobRequestID] == 0:
                    ...
                    for counter in reducerTasksList:
